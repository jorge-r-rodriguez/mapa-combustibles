    ...
    <div className="space-y-5">
      <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_210px]">
        ...
        <button
          ...
          className="h-14 rounded-[1.4rem] bg-primary px-5 text-sm font-semibold text-white shadow-glow transition hover:bg-primary-dark"
        >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
              <div className="space-y-3">
                ...
                {!rankingStations.length ? (
                  <div className="panel-muted p-5 text-sm text-slate-500">
